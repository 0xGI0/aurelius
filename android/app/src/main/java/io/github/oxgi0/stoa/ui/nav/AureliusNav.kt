package io.github.oxgi0.stoa.ui.nav
...
import io.github.oxgi0.stoa.ui.theme.DarkColors
...
fun AureliusNav(navController: NavHostController = rememberNavController()) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("quote") { io.github.oxgi0.stoa.ui.screens.QuoteScreen(navController) }
            composable("books") { io.github.oxgi0.stoa.ui.screens.BooksScreen(navController) }
            composable("favorites") { io.github.oxgi0.stoa.ui.screens.FavoritesScreen(navController) }
            composable("aurel") { io.github.oxgi0.stoa.ui.screens.AurelScreen() }
            composable("stoa") { io.github.oxgi0.stoa.ui.screens.StoaScreen() }
            ...
            composable("read/{id}") { entry ->
                ...
                io.github.oxgi0.stoa.ui.screens.ReadScreen(navController, id)
            }
        }
    }
}
...
private fun PlaceholderScreen(titleRes: Int) {
    Screen(center = true) {
        Text(
            ...
            color = io.github.oxgi0.stoa.ui.theme.LocalColors.current.text,
        )
    }
}
