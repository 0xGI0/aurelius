...
import io.github.oxgi0.stoa.ui.components.QuoteCard
import io.github.oxgi0.stoa.ui.components.Screen
import io.github.oxgi0.stoa.ui.components.Segmented
import io.github.oxgi0.stoa.ui.components.TopicChips
    ...
    Screen {
        ...
        Row(
            ...
            Row(
                ...
                val brands = listOf(
                    "AURELIUS" to io.github.oxgi0.stoa.data.Author.Aurel,
                    "EPIKTET" to io.github.oxgi0.stoa.data.Author.Epiktet,
                    "SENECA" to io.github.oxgi0.stoa.data.Author.Seneca,
                )
        ...
        Column(
            ...
            Image(
                painter = painterResource(
                    when (state.author) {
                        io.github.oxgi0.stoa.data.Author.Epiktet -> R.drawable.epictetus
                        io.github.oxgi0.stoa.data.Author.Seneca -> R.drawable.seneca
                        else -> R.drawable.marcus_medallion
                    }
                ),
                contentDescription = stringResource(
                    when (state.author) {
                        io.github.oxgi0.stoa.data.Author.Epiktet -> R.string.acc_engraving
                        io.github.oxgi0.stoa.data.Author.Seneca -> R.string.acc_seneca_bust
        ...
        Column(
            ...
            Row(
                ...
                Segmented(
                    listOf(
                        ...
                        stringResource(
                            if (state.author == io.github.oxgi0.stoa.data.Author.Seneca)
                                R.string.lang_la else R.string.lang_grc
                        ),
                    ),
                    langs.indexOf(state.quoteLang),
                ) { i -> vm.setQuoteLang(langs[i]) }
                io.github.oxgi0.stoa.ui.components.FavoriteStar(displayed.id)
            }
            ...
            io.github.oxgi0.stoa.ui.components.ExplainSection(displayed, state.quoteLang)
        }
    }
}
